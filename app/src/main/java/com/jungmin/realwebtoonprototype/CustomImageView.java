...
public class CustomImageView extends ImageView {
    ...
    public CustomImageView(Context mContext, AttributeSet attributeSet){super(mContext, attributeSet);}
    public CustomImageView(Context mContext, AttributeSet attributeSet, int style){super(mContext, attributeSet, style);}
